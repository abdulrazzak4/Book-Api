...
namespace Book_Test
{
    public class PublishersServiceTest
    {
        ...
        [Test, Order(3)]
        public void GetAllPublishers_WithNoSortBy_WithSearchString_WithPageNONumber_Test()
        {
        ...
        [Test, Order(4)]
        public void GetAllPublishers_WithSortBy_WithNoSearchString_WithPageNONumber_Test()
        {
        ...
        public void AddPublisher_WithException_Test()
        {
            ...
            Assert.That(() => publishersService.
                                AddPublisher(newPublisher), Throws.Exception.
                                                                        TypeOf<PublisherNameException>().With.Message.
                                                                        EqualTo("Name starts with  number"));
        }
